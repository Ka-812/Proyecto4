...
En esta sección, utilizando el código brindado por el profesor como base, se determina y grafica la densidad espectral de potencia, donde se comprueba que el máximo de potencia se consigue a 5000 Hz que es la frecuencia a la que viajan las portadoras, el resultado generado se logra observar a continuación:   
